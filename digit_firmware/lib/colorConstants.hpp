...
class colorMap_c {
    public:
    const std::map<std::string, RGB> rgbMap
        {
            {"Barn Red",  RGB(0x801100)},
            {"EngineeringInternationalOrange", RGB(0xB62203)},
            {"Sinopia",  RGB(0xD73502)},
            {"Orange",  RGB(0xFC6400)},
            {"PhilippineOrange",  RGB(0xFF7500)},
            {"GoldenPoppy",  RGB(0xFAC000)},
            {"RED",  RGB(0, 255, 0)},
            {"GREEN",  RGB(0, 255, 0)},
            {"BLUE",  RGB(0, 0, 255)},
